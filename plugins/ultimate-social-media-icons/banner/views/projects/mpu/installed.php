...
<div class="ci-left-part ci-already-installed-state">
  ...
  <p>Just go to <a href="https://www.ultimatelysocial.com/usm-premium/?utm_source=usmi_settings_page&utm_campaign=usm_bottom_banner_to_checkout&utm_medium=banner" target="_blank">Sellcodes</a>, click on “Share & earn cash” (next to the title) and follow the steps :)</p>
  <div class="ci-check-it-out-button">
    <a href="https://www.ultimatelysocial.com/usm-premium/?utm_source=usmi_settings_page&utm_campaign=usm_bottom_banner_to_checkout&utm_medium=banner" target="_blank" class="ci-button-link ci-round-button">Check it out</a>
  </div>
</div>
